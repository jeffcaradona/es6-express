...
### How It Works
- **Namespaced output**: Each module has its own namespace (e.g., `es6-express5:application`, `es6-express5:route`)
...
```javascript
debugServer      // es6-express5:server      - Server startup and lifecycle
debugApplication // es6-express5:application - App initialization and config
debugRoutes      // es6-express5:route       - Route handling and middleware
```
...
```bash
DEBUG=es6-express5:* npm start
```

**Enable specific namespaces:**
```bash
DEBUG=es6-express5:application,es6-express5:route npm start
```
...
Output Stream 1 (Stderr - Debug):
  es6-express5:application App initialized with config: {...}
  es6-express5:route GET / matched indexRouter
  es6-express5:application Connecting to database...
...
|------|------|-------------|--------------|
| Trace app startup | `debug.js` | Dev | `DEBUG=es6-express5:application npm start` |
...
```bash
DEBUG=es6-express5:route npm start
...
3. Redeploy with DEBUG=es6-express5:* in environment
